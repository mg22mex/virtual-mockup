...
class WorksheetExporter:
    ...
    def render_backpack_with_pdf_template(
        ...
        """Venture Dry Pack — Paula v2 page + recolored client logo overlay.

        Selects Options #1–#9 by placement × fabric for layout/colorway, then
        stamps the uploaded mark (SVG recolored via ``recolor_svg_artwork`` /
        ``prepare_logo``) over Paula's baked Graphic Sample placeholders.
