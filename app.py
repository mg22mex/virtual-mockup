...
def _preview_pages(
    ...
    logo = None
    if family != "backpack" and logo_bytes and logo_name:
        color_override = (
            None if logo_color_name == "Match uploaded art" else job.logo_hex
        )
...
def _run_app() -> None:
    ...
    if logo_bytes and logo_name:
        ...
        if family == "backpack":
            # Ticket only — Paula static pages already include artwork.
            pass
        else:
            try:
                color_override = (
